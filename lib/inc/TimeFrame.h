...
void MeasureCollection<TryCOUNT>::BenchmarkTextBrief(std::ostringstream &ss)
{
    ...
    ss  << "NAME        : " << _name                    << std::endl
        << "  Req Count : " << _data.size()             << std::endl
        << "  Mean      : " << TimespecText(Mean())     << std::endl
        << "  Medaian   : " << TimespecText(Median())   << std::endl
        << "  Min       : " << TimespecText(min)        << std::endl
        << "  Max       : " << TimespecText(max)        << std::endl;
}
